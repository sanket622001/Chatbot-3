...
class ChatBot():
    ...
    def process_user_request(self, user_input):
        ...
        if any(i in user_input for i in ["incident", "tickets","ticket","Tickets","Ticket","Incident","Status","status"]):
...
ai = ChatBot(name="dev")
openai.api_key = "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"
